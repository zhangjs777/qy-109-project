...
public class RedisService<T> {
    ...
    * @Params: [key, value, nxxx, expx, seconds]
    ...
    */
    ...
    /**
    * @Author: js.zhang
    * @Description: 从redis中查询单个数据
    * @DateTime: 2020/7/10 16:04
    * @Params: [key]
    * @Return T
    */
    ...
    /**
    * @Author: js.zhang
    * @Description: 从redis中查询数据(value是字符串)
    * @DateTime: 2020/7/10 16:06
    * @Params: [key]
    * @Return java.lang.String
    */
