...
//        PageInfo<Equipment> equipmentInfo= equipmentService.getEquipmentByUnitId(equipmentService);
//
//        if (!"".equals(equipmentInfo) && null !=equipmentInfo){
//            //（true）有值，返回成功结果
//            return super.operationSuccess(equipmentInfo);
//        }else {
//            //(false)无值，返回失败结果
